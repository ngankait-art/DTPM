...
if __name__=='__main__':
    ...
    plt.tight_layout(); fig.savefig('outputs/fig5_reproduction.png', dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout(); fig7.savefig('outputs/fig7_reproduction.png', dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout(); fig8.savefig('outputs/fig8_reproduction.png', dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout(); fig_sp.savefig('outputs/species_overview.png', dpi=150, bbox_inches='tight')
