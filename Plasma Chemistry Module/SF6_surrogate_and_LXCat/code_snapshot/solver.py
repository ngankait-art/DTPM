...
from sf6_rates import rates as _legacy_rates
...
class TELSolver:
    ...
    def __init__(self, R_icp=0.038, L_icp=0.1815, R_proc=0.105,
        ...
        if rate_mode == 'lxcat':
            ...
            self._rates_fn = lxcat_rates
        else:
            self._rates_fn = _legacy_rates
        self.R_icp = R_icp
        self.R_proc = R_proc
        self.L_icp = L_icp
        self.L_proc = L_proc
...
class TELSolverWithEnergy(TELSolver):
    ...
    def _solve_Te_energy_pde(self, ne, nSF6):
        ...
        k_chem = self._rates_fn(Te_guess)
