...
Multi-species power and pressure sweeps for the neutral and charged
panels are shown in Figures~\ref{fig:all_species_neutrals_power}--%
\ref{fig:all_species_charged_pressure}.  In each panel solid is the
2D solver and dashed (with markers and a $\pm 1\sigma$ band) is the
