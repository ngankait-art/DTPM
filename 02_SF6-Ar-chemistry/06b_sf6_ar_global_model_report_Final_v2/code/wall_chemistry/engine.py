...
def solve_model(P_rf=1500, p_mTorr=10, frac_Ar=0., Q_sccm=40, Tgas=300, T_neg=0.3,
                ...
                use_troe=True, wall_chem=False, reactor=None,
                init_Te=None, init_ne=None, init_alpha=None, init_ns=None):
    """Solve with Penning ionization, Ar* quenching, and optional wall chemistry.
    
    wall_chem: bool or dict with keys s_F, s_SFx, p_fluor, p_wallrec, p_FF, p_F_SF3, p_F_SF4.
    reactor: Reactor object or None (defaults to Lallement geometry R=0.18m, L=0.175m).
    """
    R = reactor if reactor is not None else Reactor()
    P_abs = P_rf*eta
